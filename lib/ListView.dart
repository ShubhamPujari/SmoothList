  ...
  Widget build(BuildContext context) {
    return ViewModelBuilder<ListViewModel>.reactive(
      builder: (context, model, child) => Scaffold(
        ...
        body: model.loadingStatus == LoadingStatus.loading
            ? LoadingConst.loadingAlert(context)
            : SafeArea(
                bottom: false,
                child: new ListView.builder(
                    ...
                    itemBuilder: (context, int index) {
                      ...
                      return Padding(
                        ...
                        child: Parent(
                          style: ParentStyle()
                            ..elevation(currentItem.isSelected ? 8 : 3)
                            ..borderRadius(all: 4.0)
                            ..scale(currentItem.isSelected ? 0.98 : 1.0)
