...
class ListViewModel extends BaseViewModel{
  ...
  void _populateUsers()async{
    ...
    this.usersList = usersTempList.map((usrMod) => UsersListViewModel(userModel: usrMod)).toList();
    notifyListeners();
    this.loadingStatus =this.usersList.isEmpty?LoadingStatus.loading: LoadingStatus.completed;
    notifyListeners();
  }
